...
❗ здесь только местами есть паттерны хорошей архитектуры и почти нигде нет покрытия тестами - эти must-have`ы хорошего программиста вы можете посмотреть в моих проектах на GO. Здесь это упущено ради более приоритетных проектов.  
...
Студент, специализирующийся на антропологии, решил использовать
свои знания в области системного программирования для обучения африканских
бабуинов. Бабуины движутся через глубокий каньон по канату в двух направлениях:
западном и восточном. Одновременно в одном направлении может двигаться
произвольное количество бабуинов, но если бабуины движутся по канату навстречу, то
возникает тупик. Разработайте два варианта контролирующей системы: все бабуины
равноправны.
